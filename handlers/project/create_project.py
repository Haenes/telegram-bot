...
async def name_enter(message: Message, state: FSMContext):
    ...
    await message.answer("Good, now <b>enter description of the project:</b>", parse_mode="HTML")
...
async def description_enter(message: Message, state: FSMContext):
    ...
    await message.answer("Good, now <b>enter key of the project:</b>", parse_mode="HTML")
...
async def key_enter(message: Message, state: FSMContext):
    ...
    await message.answer("Good, now <b>select type of the project:</b>", parse_mode="HTML", reply_markup=make_row_keyboard(PROJECT_TYPES))
...
async def type_selected(message: Message, state: FSMContext):
    ...
    await message.answer("Good, now <b>select whether the project will be a favorite or not:</b>", parse_mode="HTML", reply_markup=make_row_keyboard(PROJECT_FAVORITE))
